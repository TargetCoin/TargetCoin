...
uint256 hashGenesisBlock("0x7d8f2f17ae7121eccbcd44a9da118cb182fc0490c635d15f60e75dcabc44e026");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7d8f2f17ae7121eccbcd44a9da118cb182fc0490c635d15f60e75dcabc44e026");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1391386793; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1247204;

        if (fTestNet)
        {
            block.nTime    =1391386793;
            block.nNonce   = 1247204;
        }

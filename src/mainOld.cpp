...
uint256 hashGenesisBlock("0xc4891abce78d803184e50e2f5dca66814375259996393dfb827098b44223c221");
...
const string strMessageMagic = "TargetCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // TargetCoin: 1 days
static const int64 nTargetSpacing = 120; // TargetCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal targetcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TargetCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "abcderf ghtja eiipowuep  jdsf;j;a    jd;aj";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391365646; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 524250;

        if (fTestNet)
        {
            block.nTime    = 1391365646 ;
            block.nNonce   =  0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3781192b1c8ece21ae0639a6673c0d5996f9dbf7915867b543208f7654915e57"));
